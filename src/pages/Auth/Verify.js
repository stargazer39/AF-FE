          ...
          <div className="flex bg-gray-200 justify-center items-center w-3/5 h-screen  p-16">
            <form onSubmit={handleForm} className="flex flex-col items-center">
              ...
              <div className='w-full flex justify-end'>
                <button className="bg-blue-500 hover:bg-blue-600 w-36 active:bg-blue-700 font-bold mt-8 w-1/4 h-10 rounded-[5px] flex justify-center items-center text-base font-normal">
                  Continue
                </button>
              </div>
            </form>
