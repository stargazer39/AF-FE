  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-gray-200 rounded-lg w-2/6">
        <h1 className=" text-center pt-4 text-2xl">Remove your Answer</h1>
        <div className="pt-4 pb-16 pl-8 pr-8 flex text-xl items-center justify-center w-full">
          {!loadingIcon ? 
          <h1>Keep in mind that this action cannot be undone. You sure about removing?</h1>
          : 
        ...
        <div className="flex justify-center px-4 pb-4">
          ...
          <button onClick={remove} className="px-4 py-2 rounded-md text-white bg-red-500 hover:bg-red-600 focus:outline-none focus:bg-red-700">Remove Answer</button>
        </div>
      </div>
    </div>
  );
